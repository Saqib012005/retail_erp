...
//const theme = colorConfig[cardColor];
    return(
    ...
    color: primaryColor,
            ...
            <div className='min-w-0'>
              ...
              <span className='text-medium rounded font-semibold'
              style={{
    backgroundColor: `${primaryColor}15`,
    color: primaryColor,
  }}
          ...
          <div className='flex gap-3 mt-3' >
            ...
            <div className='flex'>
              ...
              <span className='text-sm text-[#6B7280]'>{permissionCount} Permissions</span>
            </div>
          </div>
           ...
           <div className="mx-4 border-t border-slate-200" >
            <div className="flex flex-wrap items-center gap-2 mt-3">
              ...
              type="button"
              //onClick={()=> onEdit?.(role)}
               className="flex items-center h-9 rounded gap-2 text-sm text-blue-500 bg-blue-50"
          >
                      <Pencil size={13} />
                      Edit
              ...
              className="flex items-center h-10 rounded gap-2 bg-green-50 text-sm text-green-500"
              >
                      <Copy size={13} />
                 Clone   
              </button>
              ...
              //onClick={()=> onDelete?.(role)}
               className="flex items-center h-10 rounded gap-2 text-sm text-red-500 bg-red-50"
              >
                      <Trash2 size={13} />  
              </button>
            </div>
